...
/**
 * Created by IntelliJ IDEA. User: elbatya Date: 15/03/2011 Time: 18:54 To change this template use File | Settings |
 * File Templates.
 */
...
public class PlotBand implements Serializable {
	...
	public PlotBand setThickness(String thickness) {

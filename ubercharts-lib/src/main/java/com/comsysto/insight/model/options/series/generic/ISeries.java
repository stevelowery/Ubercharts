...
public interface ISeries<DataType> extends Serializable {
	 ...
	 * <p/>
	 * The concrete implementation of this interface defines which kind of data is allowed, read its JavaDocs for
	 * detailed information. To see which data are generally supported by Highcharts, look at
